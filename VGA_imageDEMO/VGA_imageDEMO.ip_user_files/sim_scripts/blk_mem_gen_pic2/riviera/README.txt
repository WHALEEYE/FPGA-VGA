...
#
# Generated by export_simulation on Wed Dec 23 00:03:57 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_pic2.sh' script.

./blk_mem_gen_pic2.sh -reset_run
...
./blk_mem_gen_pic2.sh -noclean_files

For more information on the script, please type './blk_mem_gen_pic2.sh -help'.
