...
HD_PWD='F:/VGA/VGA_imageDEMO/VGA_imageDEMO.runs/blk_mem_gen_pic2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_pic2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_pic2.tcl
